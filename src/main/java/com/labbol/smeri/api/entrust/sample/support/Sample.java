...
public class Sample {
	...
	private String torqueCoefficient;
	
	private String torqueLevel;
	...
	public String getTorqueCoefficient() {
		return torqueCoefficient;
	}

	public void setTorqueCoefficient(String torqueCoefficient) {
		this.torqueCoefficient = torqueCoefficient;
	}

	public String getTorqueLevel() {
		return torqueLevel;
	}

	public void setTorqueLevel(String torqueLevel) {
	...
	public void setExcitationVoltage(String excitationVoltage) {
		this.excitationVoltage = excitationVoltage;
	}
